...
echo date('d-m-Y'); ?> &nbsp; &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust" title="Logout">Keluar</a> </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    Copyright © 2023 All rights reserved. Template by <a href="http://instagram.com/wisnuwicaksn">Kelompok Kami</a>
                    <br> Developed By <a href="wa.me/089637679707" target="_blank"><b>TI.21.C.2</b></a>
                </div>
            </div>
        </div>
